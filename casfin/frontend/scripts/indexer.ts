...
const ADDRESSES = {
  coinFlip:
    process.env.NEXT_PUBLIC_FHE_COIN_FLIP_ADDRESS || "0xBD4F422FCbA6e197729074eB0eA41Fdb805Bc71C",
  dice:
    process.env.NEXT_PUBLIC_FHE_DICE_ADDRESS || "0xc95b343bA9dfd00e6a345Eb552FD3a4576EfCBb7",
  crash:
    process.env.NEXT_PUBLIC_FHE_CRASH_ADDRESS || "0xB68F64AbC208e5c011Cb2D6e23f52Aa43599e5Ee",
  vault:
