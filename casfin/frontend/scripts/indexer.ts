...
const ADDRESSES = {
  coinFlip:
    process.env.NEXT_PUBLIC_FHE_COIN_FLIP_ADDRESS || "0x7Bc01d9e3437126345Cd9201ccbAB43D51201411",
  dice:
    process.env.NEXT_PUBLIC_FHE_DICE_ADDRESS || "0x9FA71Fa44a4a1128288D88Dd48E2B4e2D00FB778",
  crash:
    process.env.NEXT_PUBLIC_FHE_CRASH_ADDRESS || "0xDA1d641BfAfef4A6D435Da67AAE1760c1Ce0eF9E",
  vault:
