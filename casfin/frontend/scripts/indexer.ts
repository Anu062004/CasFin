...
const ADDRESSES = {
  coinFlip:
    process.env.NEXT_PUBLIC_FHE_COIN_FLIP_ADDRESS || "0x6dd64A41E8c2AC90eaC95b0a194c8943D40Fe945",
  dice:
    process.env.NEXT_PUBLIC_FHE_DICE_ADDRESS || "0x62dA6E0a33e0E1B67240348e768dD3Aed9feFDAB",
  crash:
    process.env.NEXT_PUBLIC_FHE_CRASH_ADDRESS || "0xA204279bBb036e31Fc9cbFC7d6660c29E18D6F45",
  vault:
    process.env.NEXT_PUBLIC_FHE_VAULT_ADDRESS || "0xDe635798122487CF0a61512D2D7229D28436d9f8",
  marketFactory:
    process.env.NEXT_PUBLIC_FHE_MARKET_FACTORY_ADDRESS || "0xC876De943508B4938d3d8f010cc97dbac7Ab0B43",
};
